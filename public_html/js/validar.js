...
$(function () {
    var cargarCmbDos = function () {
        //capturamos el item seleccionado del primer comb
        var seleccion = $('#id_cmbRegion').val();
        ...
        opciones[seleccion].forEach(function (element, index) {
            $('#id_cmbComuna').append('<option value="' +
                    element + '">' + element + '</option>');
        });
        $('#id_cmbRegion').change(cargarCmbDos);
...
//    messages:{
//        "txtEmail":{
//            required:"Inrese un correo electronico",
//            email:"ingrese un correo electronico correcto"
//        }
//    }
//});

$(function () { $('#my-form').validate({
        rules: {
            "txtEmail": {
                required: true,
                email: true
